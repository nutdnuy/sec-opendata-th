...
.venv/bin/python -m secopendata request --method POST --path /v1/<category>/<path> --json '{"next_cursor":""}'
```

Use `skills/sec-opendata/SKILL.md` as the reusable operating guide. Preserve
...
and future SEC portal categories.
